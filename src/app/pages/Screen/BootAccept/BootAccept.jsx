            ...
            <div className="centered d-flex flex-column align-items-center  justify-content-center">
              ...
              <div className="the_policy_check d-flex justify-content-center">
                <div className="form-check">
                  <input type="checkbox" value={checked} onChange={handleCheckboxChanged} id="flexCheckDefault" className="form-check-out y2k-checkbox"/>
              ...
              <button disable={checked ? "false" : "true"} onClick={Next} className="accept-button m-0 d-flex justify-content-center align-items-center mt-3 mb-3" style={{border: "none", borderRadius : "9px"}}>
                Accept
              </button>
            </div>
          </div>
