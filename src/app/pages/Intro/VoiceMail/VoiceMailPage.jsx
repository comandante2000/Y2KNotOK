...
export default function VoiceMailPage({ setEpisodeOne, episodeone }) {
  ...
  const [messages, setMessages] = useState([
    ...
    { name: "Mateo", date: "12/30", episodeone: "", clickable: false , wavelenghtClass:"sound-four"},
    { name: "Mom", date: "12/28", episodeone: "", clickable: false , wavelenghtClass:"sound-five"},
    { name: "Krista", date: "12/27", episodeone: "", clickable: false ,  wavelenghtClass:"sound-six"},
    { name: "Finn", date: "12/28", episodeone: "", clickable: false ,  wavelenghtClass:"sound-one"},
    { name: "Mom", date: "12/25", episodeone: "", clickable: false ,  wavelenghtClass:"sound-five"},
    ...
    { name: "Krista", date: "12/18", episodeone: "", clickable: false ,  wavelenghtClass:"sound-six"},
    { name: "Mom", date: "12/17", episodeone: "", clickable: false ,  wavelenghtClass:"sound-five"},
  ]);
  ...
  useEffect(() => {
    if (episodeone === "replyflow1.8.1") {
      setMessages([
        ...
        { name: "Krista", date: "12/30", episodeone: "", clickable: false , wavelenghtClass:"sound-six"},
