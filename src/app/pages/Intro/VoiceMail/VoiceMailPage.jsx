...
export default function VoiceMailPage({ setEpisodeOne, episodeone, dtime }) {
  ...
  useEffect(() => {
    if (episodeone === "Flow1.7.1"||episodeone === "Flow1.7.1.1") {
      setMessages([
        {
          name: "Timothee HR",
          date: "12/30",
          ...
          <div className="voicemail-box-container">
            ...
            {messages.map((message, index) => (
              <div key={index} className="box-container">
                <div
                  className=" d-flex py-0 new-voice-mail-container"
                  type={message.clickable ? "button" : "text"}
                  onClick={
                    message.clickable
                ...
                >
                  <div className="icon-container d-flex align-items-center">
                    <div
                      ...
                      // }
                      className={
                        message.blinking ? "blink-red-icon" : "unred-icon"
                      }
                    ></div>
